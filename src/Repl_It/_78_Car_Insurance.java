...
public class _78_Car_Insurance {
...
/* First things first, your program should ask customer to provide a name, so display a message:
 ...
 "Invalid data!" and stop the program (use System.exit(0) after displaying warning message
 to stop the program).
 ...
 */
        ...
        premium += vehicleUsage.equalsIgnoreCase("business") ? 50
                : vehicleUsage.equalsIgnoreCase("pleasure") ? 10
                : vehicleUsage.equalsIgnoreCase("commute") ? 20 : 0;
