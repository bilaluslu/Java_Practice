...
public class warm_Up_Duplicates {
    /*
    ...
    list.removeIf( p -> Collections.frequency(list,p) == 1 );   // if the object unique , we will remove

        System.out.println(list);   // returns 1,1,5,5
